        ...
        Kirigami.ShadowedRectangle {
                ...
                QQC2.Button {
                    ...
                    onClicked: {
                        if (mapRect.currentScale < 5) {
                            const centrePos = { x: mapImage.width / 2, y: mapImage.height / 2 };
                            const realX = centrePos.x * mapZoom.xScale;
                            const realY = centrePos.y * mapZoom.yScale;
            ...
            Flickable {
                ...
                Image {
                    ...
                    Kirigami.Icon {
                        z: 9999
                        readonly property double rawX: root.longitudeToX(kcm.nightColorSettings.longitudeFixed)
                        readonly property double rawY: root.latitudeToY(kcm.nightColorSettings.latitudeFixed)
                    ...
                    TapHandler {
                        onTapped: event => {
                            ...
                            kcm.nightColorSettings.longitudeFixed = root.xToLongitude(clickPos.x);
                            kcm.nightColorSettings.latitudeFixed = root.yToLatitude(clickPos.y);
                        }
                    }
